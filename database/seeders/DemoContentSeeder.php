...
class DemoContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $projects = [
            ...
            // Layout: three_two_tall
            [
                'title' => 'Citroen DVC',
                'slug' => 'citroen-dvc',
                'subtitle' => 'Freelance Project | Motion Graphic, Compositing',
                'layout' => 'three_two_tall',
                'description' => '<p>Tall lower row to show a mixed-height 3/2 grid.</p>',
                'is_visible' => true,
                'sort_order' => 2,
                'meta_title' => 'Citroen DVC - 3/2 Tall Layout',
                'meta_description' => 'Tall lower row mosaic layout example',
                'media_items' => [
                    ...
                    ['type' => 'image', 'url' => 'https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?w=1200&h=700&fit=crop&sat=-25'],
                    ['type' => 'image', 'url' => 'https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?w=1200&h=700&fit=crop&sat=-35'],
                ],
            ],
            ...
            [
                ...
                'subtitle' => 'Freelance Project | Motion Graphic, Compositing',
                'layout' => 'single',
                'description' => '<p>Single hero media to show the one-up layout.</p>',
                'is_visible' => true,
                'sort_order' => 4,
                'meta_title' => 'Order Sekarang - Single Layout',
                'meta_description' => 'Single hero layout example',
                'media_items' => [
