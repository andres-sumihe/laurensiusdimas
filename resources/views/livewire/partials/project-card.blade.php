    ...
    @elseif($layout === 'two')
        ...
        <div class="grid grid-cols-12 gap-0 w-full">
            @foreach($mediaItems->take(2) as $item)
                <div class="col-span-6 relative group overflow-hidden bg-neutral-100 aspect-[4/3] md:aspect-[16/9]">
                    @if($item['type'] === 'video')
                        <video class="h-full w-full object-cover" autoplay muted loop playsinline poster="{{ $item['thumb'] }}">
                            <source src="{{ $item['url'] }}" type="video/mp4">
                        </video>
    ...
    @elseif($layout === 'three_two')
        ...
        <div class="grid grid-cols-12 gap-0 w-full">
            @foreach($mediaItems->take(3) as $item)
                <div class="col-span-4 relative group overflow-hidden bg-neutral-100 aspect-[4/3] md:aspect-[16/9]">
                    @if($item['type'] === 'video')
                        <video class="h-full w-full object-cover" autoplay muted loop playsinline poster="{{ $item['thumb'] }}">
                            <source src="{{ $item['url'] }}" type="video/mp4">
                        </video>
    ...
    @elseif($layout === 'four_one')
        ...
        <div class="grid grid-cols-12 gap-0 w-full">
            @foreach($mediaItems->take(4) as $item)
                <div class="col-span-3 relative group overflow-hidden bg-neutral-100 aspect-[4/3] md:aspect-[16/9]">
                    @if($item['type'] === 'video')
                        <video class="h-full w-full object-cover" autoplay muted loop playsinline poster="{{ $item['thumb'] }}">
                            <source src="{{ $item['url'] }}" type="video/mp4">
                        </video>
